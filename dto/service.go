...
type ServiceListInput struct {
	Info     string `json:"info" form:"info" comment:"关键词" example:"" validate:""`                      // 关键词                    //关键词
	PageNo   int    `json:"page_no" form:"page_no" comment:"页数" example:"1" validate:"required"`        // 当前页数        //页数
...
type ServiceListItemOutput struct {
	...
	LoadType    int    `json:"load_type" form:"load_type"`       //类型 0:http, 1:tcp, 3:grpc
